...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('work_details') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:46 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Work Details || Floens || HTML Template For Tiling & Flooring</title>
    <!-- favicons Icons -->
                ...
                <div class="row gutter-y-60">
                    <div class="col-lg-8">
                        <div class="work-details__content">
                            <div class="work-details__image wow fadeInUp" data-wow-delay="00ms"
                                data-wow-duration="1500ms">
                                <img src="assets/images/works/project-d-1.jpg" alt="work-details">
                            </div><!-- /.work-details__image -->
                            <h3 class="work-details__title">It is a long established fact that a reader will be</h3>
                            <!-- /.work-details__title -->
                            <p class="work-details__text work-details__text--one wow fadeInUp" data-wow-delay="00ms"
                                data-wow-duration="1500ms">There are many variations of passages of Lorem Ipsum
                                ...
                                uses a dictionary of over 200 Latin words,</p><!-- /.work-details__text -->
                            <h3 class="work-details__title">Where can I get some?</h3><!-- /.work-details__title -->
                            <p class="work-details__text work-details__text--two wow fadeInUp" data-wow-delay="00ms"
                                data-wow-duration="1500ms">mistaken idea of denouncing pleasure and praising pain was
                                ...
                                one rejects, dislikes,</p><!-- /.work-details__text -->
                            <div class="work-details__inner">
                                <div class="row gutter-y-30">
                                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="00ms"
                                        data-wow-duration="1500ms">
                                        <div class="work-details__inner__image">
                                            <img src="assets/images/works/project-d-1-1.jpg" alt="work-details">
                                        </div><!-- /.work-details__inner__image -->
                                    </div><!-- /.col-lg-6 -->
                                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="200ms"
                                        data-wow-duration="1500ms">
                                        <div class="work-details__inner__image">
                                            <img src="assets/images/works/project-d-1-2.jpg" alt="work-details">
                                        </div><!-- /.work-details__inner__image -->
                                    </div><!-- /.col-lg-6 -->
                                </div><!-- /.row -->
                            </div><!-- /.work-details__inner -->
                            <p class="work-details__text work-details__text--three wow fadeInUp" data-wow-delay="00ms"
                                data-wow-duration="1500ms">There are many variations of passages of Lorem Ipsum
                                available, but the majority have suffered alteration in some form, by injected humour,
                                or randomised words which don't look even slightly believable. If you are going to use a
                                passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in
                                ...
                                predefined chunks as necessary, making this the first true generator on the Internet. It
                                uses a dictionary of over 200 Latin words,</p><!-- /.work-details__text -->
                            <div class="work-details__testimonial wow fadeInUp" data-wow-delay="00ms"
                                data-wow-duration="1500ms">
                                <p class="work-details__testimonial__text">Constix Construction Company also impressed
                                    us with their transparency regarding costs. The initial quote was accurate, and they
                                    were upfront about any changes or additional expenses</p>
                                <!-- /.work-details__testimonial__text -->
                                <svg class="work-details__testimonial__icon" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 38 28" fill="none">
                                    <path
                                        d="M0 17.4101H7.62083L2.54024 27.5712H10.1611L15.2417 17.4101V2.16846H0V17.4101Z" />
                                    <path
                                        d="M20.3223 2.16846V17.4101H27.9431L22.8625 27.5712H30.4833L35.5639 17.4101V2.16846H20.3223Z" />
                                    <path
                                        d="M9.7888 14.7417H2.66797V0.5H16.9096V15.1236L12.02 24.9027H5.51723L10.236 15.4653L10.5978 14.7417H9.7888Z" />
                                    <path
                                        d="M30.1111 14.7417H22.9902V0.5H37.2319V15.1236L32.3423 24.9027H25.8395L30.5583 15.4653L30.9201 14.7417H30.1111Z" />
                                </svg>
                            </div><!-- /.work-details__testimonial -->
                            <p class="work-details__text work-details__text--four wow fadeInUp" data-wow-delay="00ms"
                                data-wow-duration="1500ms">mistaken idea of denouncing pleasure and praising pain was
                                born and I will give you a complete account of the system, and expound the actual
                                teachings of the great explorer of the truth, the master-builder of human happiness. No
                                one rejects, dislikes,</p><!-- /.work-details__text -->
                        </div><!-- /.work-details__content -->
                    </div><!-- /.col-lg-8 -->
                    <div class="col-lg-4 wow fadeInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <aside class="work-details__sidebar">
                            <h3 class="work-details__sidebar__title">Project Information</h3>
                            ...
                            <div class="work-details__sidebar__inner">
                                <div class="work-details__sidebar__info work-details__sidebar__info--client">
                                    <h4
                                        class="work-details__sidebar__info__title work-details__sidebar__info__title--client">
                                        Client:</h4><!-- /.work-details__sidebar__info__title -->
                                    <a href="mailto:floens@infomail.com"
                                        class="work-details__sidebar__info__text work-details__sidebar__info__text--link">floens@infomail.com</a><!-- /.work-details__sidebar__info__text -->
                                </div><!-- /.work-details__sidebar__info -->
                                <div class="work-details__sidebar__info">
                                    <h4 class="work-details__sidebar__info__title">Category:</h4>
                                    <!-- /.work-details__sidebar__info__title -->
                                    <p class="work-details__sidebar__info__text">Building Constractions</p>
                                    <!-- /.work-details__sidebar__info__text -->
                                </div><!-- /.work-details__sidebar__info -->
                                <div class="work-details__sidebar__info">
                                    <h4 class="work-details__sidebar__info__title">Start Date:</h4>
                                    <!-- /.work-details__sidebar__info__title -->
                                    <p class="work-details__sidebar__info__text">10 June, 2023</p>
                                    <!-- /.work-details__sidebar__info__text -->
                                </div><!-- /.work-details__sidebar__info -->
                                <div class="work-details__sidebar__info">
                                    <h4 class="work-details__sidebar__info__title">End Date:</h4>
                                    <!-- /.work-details__sidebar__info__title -->
                                    <p class="work-details__sidebar__info__text">10 october, 2023</p>
                                    <!-- /.work-details__sidebar__info__text -->
                                </div><!-- /.work-details__sidebar__info -->
                                <div class="work-details__sidebar__info">
                                    <h4 class="work-details__sidebar__info__title">Tag:</h4>
                                    <!-- /.work-details__sidebar__info__title -->
                                    <p class="work-details__sidebar__info__text"><span>construction</span>,
                                        <span>building</span>, <span>factory</span>
                                    </p>
                                    <!-- /.work-details__sidebar__info__text -->
                                </div><!-- /.work-details__sidebar__info -->
                                <div class="work-details__sidebar__info">
                                    <h4 class="work-details__sidebar__info__title">project budget:</h4>
                                    <!-- /.work-details__sidebar__info__title -->
                                    <p class="work-details__sidebar__info__text">$25800.99</p>
                                    <!-- /.work-details__sidebar__info__text -->
                                </div><!-- /.work-details__sidebar__info -->
                            </div><!-- /.work-details__sidebar__inner -->
                        </aside><!-- /.work-details__sidebar -->
                    </div><!-- /.col-lg-4 -->
                </div><!-- /.row -->
            </div><!-- /.container -->
        </section><!-- /.work-details section-space -->
...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('work_details') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:48 GMT -->
