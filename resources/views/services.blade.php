...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('services') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:41 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Services || Floens || HTML Template For Tiling & Flooring</title>
    <!-- favicons Icons -->
                ...
                <div class="row gutter-y-30">
                    <div class="col-xl-4 col-md-6">
                        <div class="service-card-two">
                            ...
                            <div class="service-card-two__image">
                                <img src="assets/images/services/service-2-1.jpg" alt="Indian Marbel">
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-card-two">
                            ...
                            <div class="service-card-two__content">
                                <h3 class="service-card-two__title"><a
                                        href='{{ Route('serviced_industrial_flooring') }}'>Granites</a>
                                </h3>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-card-two">
                            ...
                            <div class="service-card-two__content">
                                <h3 class="service-card-two__title"><a
                                        href='{{ Route('serviced_vinyl_plank') }}'>Imported Marbel</a></h3>
                                <div class="service-card-two__bottom">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-card-two">
                            ...
                            <div class="service-card-two__content">
                                <h3 class="service-card-two__title"><a
                                        href='{{ Route('serviced_vein_patterns') }}'>Sand Stones</a></h3>
                                <!-- /.service-card-two__title -->
                                <div class="service-card-two__bottom">
