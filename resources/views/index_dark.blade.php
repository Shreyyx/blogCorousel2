...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('index_dark') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:32 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/floens-dark.css" />
</head>
    ...
    <div class="page-wrapper">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-8 mx-auto">
                                <div class="main-slider-three__content">
                                    ...
                                    <h2 class="main-slider-three__title">High Quality Tile & Flooring for your home
                    ...
                    <div class="col-lg-6">
                        <div class="about-three__content">
                            <div class="sec-title @@extraClassName">
                                ...
                                <h3 class="sec-title__title">No 1. Tiles And Stone Company In Town</h3>
                                <!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
                            ...
                            <p class="about-three__text wow fadeInUp" data-wow-duration="1500ms">Tiles company, also
                                known as a tile manufacturer or distributor, specializes in the production and
                                distribution of various types of tiles used for a wide range of applications. These
                                companies play a crucial</p><!-- /.about-three__text -->
                            <div class="about-three__progress">
                                <div class="progress-box">
                                    <h4 class="progress-box__title">Hardwood Floor Repair</h4>
                                    <!-- /.progress-box__title -->
                ...
                <div class="services-three__inner"
                    ...
                    <div class="services-three__inner__wrapper">
                        <a href="https://www.youtube.com/watch?v=h9MbznbxlLc"
                            class="services-three__inner__video video-button video-button--large video-popup"
                            style="background-image: url(assets/images/resources/slider-video-bg.png);">
                            <span class="icon-play"></span>
                            <i class="video-button__ripple"></i>
                        </a><!-- /.video-button services-three__inner__video -->
                        <div class="services-three__inner__content">
                            <div class="services-three__inner__counter">
                                ...
                                <h4 class="services-three__counter__title">Saticfied clients</h4>
                                <!-- /.services-three__counter__title -->
                            </div><!-- /.services-three__inner__counter -->
                            <div class="services-three__inner__counter">
                                <div class="services-three__counter count-box">
                        ...
                        </div><!-- /.services-three__inner__content -->
                    </div><!-- /.services-three__inner__wrapper -->
                </div><!-- /.services-three__inner -->
            </div><!-- /.container -->
            <div class="container-fluid">
                ...
                "1600":{
                    ...
                    <div class="item">
                        <div class="service-card-two">
                            ...
                            <div class="service-card-two__content">
                                <h3 class="service-card-two__title"><a
                                        href="{{ Route('industriald_flooring') }}">Industrial
                                        Flooring</a></h3><!-- /.service-card-two__title -->
                                <div class="service-card-two__bottom">
                                    <a href="{{ Route('industriald_flooring') }}"
                                        class="service-card-two__link floens-btn">
                                        <span>service details</span>
                                        <i class="icon-right-arrow"></i>
                                    </a>
                    ...
                    <div class="item">
                        <div class="service-card-two">
                            ...
                            <div class="service-card-two__content">
                                <h3 class="service-card-two__title"><a
                                        href='{{ Route('serviced_vinyl_plank') }}'>Vinyl
                    ...
                    <div class="item">
                        <div class="service-card-two">
                            ...
                            <div class="service-card-two__content">
                                <h3 class="service-card-two__title"><a
                                        href='{{ Route('serviced_oak_flooring') }}'>Oak
                                        Flooring</a></h3><!-- /.service-card-two__title -->
                                <div class="service-card-two__bottom">
        ...
        <section class="work-process section-space-two">
            ...
            <div class="work-process__container container">
                ...
                <img src="assets/images/shapes/work-process-shape-1-3-dark.png" alt="work-process-shape"
                ...
                <div class="projects-three__grid">
                    <div class="projects-three__card projects-three__card--one">
                        <div class="projects-three__card__bg"
                            style="background-image: url(assets/images/works/project-3-1.jpg);"></div>
                        <!-- /.projects-three__card__bg -->
                        <div class="projects-three__card__content">
                            <div class="projects-three__card__top">
                                <h3 class="projects-three__card__tagline">Tile Care</h3>
                                <!-- /.projects-three__card__tagline -->
                            </div><!-- /.projects-three__card__top -->
                            <h4 class="projects-three__card__title"><a href="{{ Route('work_details') }}">Wood
                                    Floor</a></h4>
                            <!-- /.projects-three__card__title -->
                        </div><!-- /.projects-three__card__content -->
                    </div><!-- /.projects-three__card -->
                    <div class="projects-three__card projects-three__card--two">
                        <div class="projects-three__card__bg"
                            style="background-image: url(assets/images/works/project-3-2.jpg);"></div>
                        <!-- /.projects-three__card__bg -->
                        <div class="projects-three__card__content">
                            <div class="projects-three__card__top">
                                <h3 class="projects-three__card__tagline">Tile Care</h3>
                            ...
                            <h4 class="projects-three__card__title"><a href="{{ Route('work_details') }}">Modern
                                    interior</a>
                            </h4><!-- /.projects-three__card__title -->
                        </div><!-- /.projects-three__card__content -->
                    </div><!-- /.projects-three__card -->
                    <div class="projects-three__card projects-three__card--three">
                        <div class="projects-three__card__bg"
                            style="background-image: url(assets/images/works/project-3-3.jpg);"></div>
                        <!-- /.projects-three__card__bg -->
                        <div class="projects-three__card__content">
                            <div class="projects-three__card__top">
                                <h3 class="projects-three__card__tagline">Tile Care</h3>
                            ...
                            <h4 class="projects-three__card__title"><a href="{{ Route('work_details') }}">Vinyl
                                    Plank</a></h4>
                            <!-- /.projects-three__card__title -->
                        </div><!-- /.projects-three__card__content -->
                    </div><!-- /.projects-three__card -->
                    <div class="projects-three__card projects-three__card--four">
                        <div class="projects-three__card__bg"
                            style="background-image: url(assets/images/works/project-3-4.jpg);"></div>
                        <!-- /.projects-three__card__bg -->
                        <div class="projects-three__card__content">
                            <div class="projects-three__card__top">
                                <h3 class="projects-three__card__tagline">Tile Care</h3>
                    ...
                    <div class="projects-three__card projects-three__card--five">
                        <div class="projects-three__card__bg"
                            style="background-image: url(assets/images/works/project-3-5.jpg);"></div>
                        <!-- /.projects-three__card__bg -->
                        <div class="projects-three__card__content">
                            <div class="projects-three__card__top">
                                <h3 class="projects-three__card__tagline">Tile Care</h3>
                    ...
                    "1800":{
                        ...
                        <div class="item">
                            <div class="gallery-one__card">
                                <img src="assets/images/gallery/gallery-slide-1-1.jpg" alt="">
                                <div class="gallery-one__card__hover">
                                    <a href="assets/images/gallery/gallery-slide-1-1.jpg" class="img-popup">
                        ...
                        <div class="item">
                            <div class="gallery-one__card">
                                <img src="assets/images/gallery/gallery-slide-1-2.jpg" alt="">
                                <div class="gallery-one__card__hover">
                                    <a href="assets/images/gallery/gallery-slide-1-2.jpg" class="img-popup">
                                        <span class="gallery-one__card__icon"></span>
                                    </a>
                                </div><!-- /.gallery-one__card__hover -->
                            </div><!-- /.gallery-one__card -->
                        ...
                        <div class="item">
                            <div class="gallery-one__card">
                                <img src="assets/images/gallery/gallery-slide-1-3.jpg" alt="">
                                <div class="gallery-one__card__hover">
                                    <a href="assets/images/gallery/gallery-slide-1-3.jpg" class="img-popup">
                                        <span class="gallery-one__card__icon"></span>
                                    </a>
                                </div><!-- /.gallery-one__card__hover -->
                            </div><!-- /.gallery-one__card -->
                        </div><!-- /.item -->
                    </div><!-- /.gallery-slide__carousel -->
                </div><!-- /.gallery-slide__inner -->
            </div><!-- /.container -->
        ...
        <section class="testimonials-three section-space">
            <div class="container">
					...
					"responsive": {
                            ...
                            <div class="testimonials-card-three">
                                <div class="testimonials-card-three__left">
                                    <div class="testimonials-card-three__image">
                                        <img src="assets/images/testimonials/testimonials-3-1.jpg"
                                            alt="Michael G. Ware">
                                    </div><!-- /.testimonials-card-three__image -->
                                    <div class="testimonials-card-three__quotes">
                                        <svg class="testimonials-card-three__quotes__icon"
                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 145 106" fill="none">
                                            <path
                                                d="M0 66.712H29.2013L9.73361 105.647H38.9349L58.4026 66.712V8.30945H0V66.712Z"
                                                fill="#8A5133" />
                                            <path
                                                d="M77.8696 8.30945V66.712H107.071L87.6032 105.647H116.805L136.272 66.712V8.30945H77.8696Z"
                                                fill="#8A5133" />
                                            <path
                                                d="M37.5109 57.9026H8.80957V0.5H66.2121V58.2845L46.9354 96.8374H18.8522L37.9581 58.6262L38.3199 57.9026H37.5109Z"
                                                stroke="#C7844F" />
                                            <path
                                                d="M115.381 57.9026H86.6797V0.5H144.082V58.2845L124.806 96.8374H96.7223L115.828 58.6262L116.19 57.9026H115.381Z"
                                                stroke="#C7844F" />
                                        </svg>
                                    </div><!-- /.testimonials-card-three__quotes -->
                                </div><!-- /.testimonials-card-three__left -->
                                <div class="testimonials-card-three__right">
                                    ...
                                    <p class="testimonials-card-three__text">"I recently worked with <a
                                            href="{{ Route('about') }}"
                                            class="testimonials-card-three__text__highlight">Floens</a> for my home
                                    ...
                                    <div class="testimonials-card-three__info">
                                        <h4 class="testimonials-card-three__name">Michael G. Ware</h4>
                                        <!-- /.testimonials-card-three__name -->
                                        <span class="testimonials-card-three__designation">managing
                                            director</span><!-- /.testimonials-card-three__designation -->
                                    </div><!-- /.testimonials-card-three__info -->
                                </div><!-- /.testimonials-card-three__right -->
                        ...
                        <div class="item">
                            <div class="testimonials-card-three">
                                <div class="testimonials-card-three__left">
                                    <div class="testimonials-card-three__image">
                                        <img src="assets/images/testimonials/testimonials-3-2.jpg"
                                ...
                                <div class="testimonials-card-three__right">
                                    ...
                                    <!-- /.testimonials-card-three__text -->
                                    <div class="testimonials-card-three__info">
                                        <h4 class="testimonials-card-three__name">Anthony B. Castillo</h4>
                                        <!-- /.testimonials-card-three__name -->
                                        <span class="testimonials-card-three__designation">managing
                                            director</span><!-- /.testimonials-card-three__designation -->
                                    </div><!-- /.testimonials-card-three__info -->
                ...
                </div><!-- /.testimonials-three__wrapper -->
            </div><!-- /.container -->
        </section><!-- /.testimonials-three section-space -->
        <!-- testimonials end -->
                        ...
                        <div class="col-lg-6">
                            <div class="team-two__top__right">
                                <p class="team-two__top__text">Luctus enim vehicula nec. Ut auctor lobortis sapien et
                                    ...
                                    tincidunt magna sed leo luctus,</p><!-- /.team-two__top__text -->
                            </div><!-- /.team-two__top__right -->
                        </div><!-- /.col-lg-6 -->
                    </div><!-- /.row -->
                </div><!-- /.team-two__top -->
            ...
            "responsive":{
                ...
                "1200":{
                    ...
                    <div class="client-carousel__one__item">
                        <img src="assets/images/resources/brand-dark-1-1.png" alt="brand">
                        <img src="assets/images/resources/brand-1-1.png" alt="brand">
                    </div><!-- /.owl-slide-item-->
                    <div class="client-carousel__one__item">
                        <img src="assets/images/resources/brand-dark-1-2.png" alt="brand">
                        <img src="assets/images/resources/brand-1-2.png" alt="brand">
                    </div><!-- /.owl-slide-item-->
                    <div class="client-carousel__one__item">
                        <img src="assets/images/resources/brand-dark-1-3.png" alt="brand">
                        <img src="assets/images/resources/brand-1-3.png" alt="brand">
                    </div><!-- /.owl-slide-item-->
                    <div class="client-carousel__one__item">
                        <img src="assets/images/resources/brand-dark-1-4.png" alt="brand">
                        <img src="assets/images/resources/brand-1-4.png" alt="brand">
                    </div><!-- /.owl-slide-item-->
                    <div class="client-carousel__one__item">
                        <img src="assets/images/resources/brand-dark-1-5.png" alt="brand">
                        <img src="assets/images/resources/brand-1-5.png" alt="brand">
                    </div><!-- /.owl-slide-item-->
                    <div class="client-carousel__one__item">
                        <img src="assets/images/resources/brand-dark-1-6.png" alt="brand">
...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('index_dark') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:35 GMT -->
