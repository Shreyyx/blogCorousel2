...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('index_2') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:04:59 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Home Two || Floens || HTML Template For Tiling & Flooring</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
		...
		"nextArrow": "<button class=\"hero-slider__slick-button hero-slider__slick-button--next\">Next <i class=\"icon-right-arrow\"><i></button>"
                    ...
                    <div class="main-slider-two__wrapper container">
                        <div class="main-slider-two__left">
                            <div class="main-slider-two__content">
                                ...
                                <a href="{{ Route('about') }}" class="main-slider-two__btn floens-btn">
                ...
                <div class="main-slider-two__item">
                    <div class="main-slider-two__bg"
                        style="background-image: url(assets/images/backgrounds/slider-2-4.jpg);"></div>
                    <!-- /.main-slider-two__bg -->
                    <div class="main-slider-two__wrapper container">
                        <div class="main-slider-two__left">
                            <div class="main-slider-two__content">
                ...
                <div class="main-slider-two__item">
                    <div class="main-slider-two__bg"
                        style="background-image: url(assets/images/backgrounds/slider-2-5.jpg);"></div>
                    <!-- /.main-slider-two__bg -->
                    <div class="main-slider-two__wrapper container">
                        <div class="main-slider-two__left">
                            <div class="main-slider-two__content">
        ...
        <section class="about-two section-space">
            <div class="about-two__bg" style="background-image: url(assets/images/backgrounds/about-bg-2-1.png);">
            </div>
            <!-- /.about-two__bg -->
            <div class="container">
                    ...
                    <div class="col-lg-6">
                        <div class="about-two__content">
                            <div class="sec-title sec-title--border">
                                ...
                                <h3 class="sec-title__title">Best Flooring & <br> Paving Company</h3>
                                <!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
                            ...
                            <div class="about-two__content__text wow fadeInUp" data-wow-duration="1500ms"
                                ...
                                <p class="about-two__text">Etiam sit amet felis dapibus libero mollis scelerisque.
                                    Vivamus purus
                                    neque, euismod a sodales et, semper ac eros. Nullam vitae augue varius, fringilla
                                    libero id,
                                    mattis odio. Aliquam vitae risus dapibus</p><!-- /.about-two__text -->
                            </div><!-- /.about-two__content__text -->
                            <div class="about-two__list wow fadeInUp" data-wow-duration="1500ms"
                            ...
                            <div class="about-two__button wow fadeInUp" data-wow-duration="1500ms"
                                ...
                                <a href="{{ Route('about') }}" class="floens-btn">
                    ...
                    <div class="col-lg-6">
                        <div class="expertise-one__content">
                            <div class="sec-title sec-title--border">
                                ...
                                <h3 class="sec-title__title">Expert Flooring <br> Installers your home</h3>
                                <!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->


                            <p class="expertise-one__text">Eleifend ut diam a, vulputate aliquam diam. Pellentesque
                                consequat
                                orci
                                neque, ut luctus enim vehicula nec. Ut auctor lobortis sapien et eleifend. Integer ac
                                orci vitae
                            ...
                            <div class="expertise-one__progress">
                                ...
                                <div class="progress-box">
                                    <h4 class="progress-box__title">We bring our showroom</h4>
                                    <!-- /.progress-box__title -->
                                    <div class="progress-box__bar">
        ...
        <section class="video-one">
            <div class="container">
                <div class="video-one__wrapper"
                    style="background-image: url(assets/images/backgrounds/video-bg-1.jpg);">
                    <a href="https://www.youtube.com/watch?v=h9MbznbxlLc"
                        class="video-button video-button--large video-popup"
                ...
                <div class="row gutter-y-60">
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="200ms">
                        <div class="faq-one__content">
                            ...
                            <p class="faq-one__text">Mollis massa turpis, eu sodales sem maximus ut. Nullam condimentum
                                eget arcu nec dapibus. Nullam tincidunt ex ut tempus malesuada.</p>
                            <!-- /.faq-one__text -->
        ...
        <section class="evaluation-schedule floens-jarallax" data-jarallax data-speed="0.3"
            style="background-image: url('assets/images/backgrounds/evaluation-schedule-bg-1.jpg');">
            <div class="container-fluid">
                <div class="evaluation-schedule__content">
                    ...
                    <a href="{{ Route('about') }}" class="evaluation-schedule__btn floens-btn">
                ...
                <div class="row gutter-y-30">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-card blog-card--two wow fadeInUp" data-wow-duration='1500ms'
                            ...
                            <div class="blog-card__image">
                                <img src="assets/images/blog/blog-1-10.jpg"
                                    alt="Talk About the Three Major Types of Floor Tiles">
                                <a href="{{ Route('blog_detailsright') }}" class="blog-card__image__link"><span
                                        class="sr-only">Talk About the Three Major Types of Floor Tiles</span>
                                    <!-- /.sr-only --></a>
...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('index_2') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:14 GMT -->
