...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('shop_details') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:06:03 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Shop Details || Floens || HTML Template For Tiling & Flooring</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">mosaic tiles</h2>
                <ul class="floens-breadcrumb list-unstyled">
                    <li><i class="icon-home"></i> <a href="{{ Route('index_2') }}">Home</a></li>
                    <li><span>shop</span></li>
                    <li><span>mosaic tiles</span></li>
        ...
        <section class="product-details section-space">
                            ...
                            <div class="swiper product-details__gallery-top">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="assets/images/products/product-d-1-1.jpg"
                            ...
                            <div class="swiper product-details__gallery-thumb">
                                <div class="swiper-wrapper">
                                    <div class="product-details__gallery-thumb-slide swiper-slide">
                                        <img src="assets/images/products/product-d-thumb-1-1.jpg"
                                            alt="product details thumb" class="product-details__gallery-thumb__img">
                                    </div>
                                    <div class="product-details__gallery-thumb-slide swiper-slide">
                                        <img src="assets/images/products/product-d-thumb-1-2.jpg"
                                            alt="product details thumb" class="product-details__gallery-thumb__img">
                                    </div>
                                    <div class="product-details__gallery-thumb-slide swiper-slide">
                                        <img src="assets/images/products/product-d-thumb-1-3.jpg"
                                            alt="product details thumb" class="product-details__gallery-thumb__img">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 col-xl-6 wow fadeInRight" data-wow-delay="300ms">
                        <div class="product-details__content">
                            ...
                            <div class="product-details__review">
                                ...
                                <a href="{{ Route('product_details') }}">(3 customer reviews)</a>
                            </div><!-- /.review-ratings -->
                            <div class="product-details__excerpt">
                                <p class="product-details__excerpt__text1">
                                    ...
                                    beatae
                                    vitae dicta sunt explicabo. Aelltes port lacus
                                </p>
                            </div><!-- /.excerp-text -->
                            <div class="product-details__color">
                                ...
                                <div class="product-details__color__box">
                                    <button type="button"
                                        class="product-details__color__btn product-details__color__btn--one"><span></span></button>
                                    <button type="button"
                                        class="product-details__color__btn product-details__color__btn--two"><span></span></button>
                                    <button type="button"
                                        class="product-details__color__btn product-details__color__btn--three"><span></span></button>
                                    <button type="button"
                                        class="product-details__color__btn product-details__color__btn--four"><span></span></button>
                                    <button type="button"
                                        class="product-details__color__btn product-details__color__btn--five"><span></span></button>
                            ...
                            <div class="product-details__buttons">
                                <a href="{{ Route('cart') }}" class="product-details__btn-cart floens-btn">
                    ...
                    <div class="product-details__description">
                        ...
                        <div class="product-details__text__box wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <p class="product-details__description__text">
                                ...
                                remaining
                                essentially unchanged. Aelltes port lacus quis enim var sed efficitur turpis gilla sed
                                sit <br>
                                amet finibus eros. Neque porro est qui dolorem ipsum quia quaed inventor veritatis et
                                quasi
            ...
            <div class="container">
                ...
                <div class="comments-one product-details__comment">
                    <h3 class="comments-one__title">02 Reviews, for Tiles</h3><!-- /.comments-one__title -->
                    <ul class="list-unstyled comments-one__list">
                        <li class="comments-one__card wow fadeInUp" data-wow-delay="100ms"
                            ...
                            <div class="comments-one__card__content">
                                ...
                                <p class="comments-one__card__text">Neque porro est qui dolorem ipsum quia quaed
                                    inventor veritatis et quasi architecto beatae vitae dicta sunt explicabo. Aelltes
                                    port lacus quis enim var sed efficitur turpis gilla sed sit amet finibus eros. Lorem
                                    Ipsum is simply dummy</p><!-- /.comments-one__card__text -->
            ...
            <div class="container">
                ...
                <div class="product-details__comments-form comments-form">
                    <div class="product-details__comments-form__top">
                        <h3 class="product-details__comments-form__title comments-form__title sec-title__title">Add a
                            Review
                        </h3><!-- /.comments-form__title -->
                        <p class="product-details__comments-form__text">Your email address will not be published.
                            Required
                            fields are marked *</p>
                        <div class="product-details__comments-form__ratings">
                            <h5 class="product-details__comments-form__ratings__text">Rate this product? *</h5>
                            <div class="floens-ratings @@extraClassName">
                                <span class="icon-star"></span>
                                <span class="icon-star"></span>
                                <span class="icon-star"></span>
                    ...
                    <form class="comments-form__form contact-form-validated form-one">
                        <div class="form-one__group form-one__group--grid">
                            <div class="form-one__control form-one__control--input wow fadeInUp"
...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('shop_details') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:06:05 GMT -->
