...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('index_rtl') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:06:16 GMT -->
...
<head>
    ...
    <!-- template styles -->
    <link rel="stylesheet" href="assets/css/floens-rtl.css" />
    <link rel="stylesheet" href="assets/css/floens-custom-rtl.css" />
    <link rel="stylesheet" href="assets/vendors/floens-toolbar/css/floens-toolbar.css">
</head>
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="main-header__inner">
                    ...
                    <div class="main-header__right">
                            ...
                            <ul class="main-menu__list">
                                                    ...
                                                    <div class="home-showcase__inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-lg-3">
                                                                <div class="demo-one__card">
                                                                    <div class="demo-one__image">
                                                                        <img src="assets/images/home-showcase/home-showcase-2.jpg"
                                                                            alt="">
                                                                        <div class="demo-one__btns">
                                                                    ...
                                                                    <div class="demo-one__content">
                                                                        <h3 class="demo-one__title">
                                                                            <a href="{{ Route('index_3') }}">Home Page
                                                                                02</a>
                                                                        </h3><!-- /.demo-one__title -->
                                                                    </div><!-- /.demo-one__content -->
                                                                </div><!-- /.demo-one__card -->
                                                            ...
                                                            <div class="col-md-6 col-lg-3">
                                                                <div class="demo-one__card">
                                                                    <div class="demo-one__image">
                                                                        <img src="assets/images/home-showcase/home-showcase-3.jpg"
                                                                            alt="">
                                                                        <div class="demo-one__btns">
                                                                            <a href="{{ Route('index_4') }}"
                                                                                class="floens-btn demo-one__btn">
                                                            ...
                                                            <div class="col-md-6 col-lg-3">
                                                                <div class="demo-one__card">
                                                                    <div class="demo-one__image">
                                                                        <img src="assets/images/home-showcase/home-showcase-4.jpg"
                                                                            alt="">
                                                                        <div class="demo-one__btns">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="{{ Route('services_grid') }}">Services Grid</a></li>
                                        <li><a href="{{ Route('services_carousel') }}">Services Carousel 01</a></li>
                                        <li><a href="{{ Route('services_carousel') }}">Services Carousel 02</a></li>
                                        <li><a href="{{ Route('serviced_industrial_flooring') }}">industrial
                                                flooring</a></li>
                                        <li><a href="{{ Route('serviced_tiling_concrete') }}">Tiling & concrete</a>
                                        </li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="{{ Route('team_carousel') }}">Team Carousel</a></li>
                                        <li><a href="{{ Route('team_details') }}">Team Details</a></li>
                                        <li>
                                            <a href="{{ Route('work') }}">Work</a>
                                            <ul>
                                                <li><a href="{{ Route('work') }}">Work</a></li>
                                                <li><a href="{{ Route('work_grid') }}">Work Grid</a></li>
                                                <li><a href="{{ Route('work_carousel') }}">Work Carousel</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="{{ Route('work_details') }}">Work Details</a></li>
                                        <li><a href="{{ Route('pricing') }}">Pricing</a></li>
                                        <li><a href="{{ Route('pricing_carousel') }}">Pricing Carousel</a></li>
                                        <li>
                                            <a href="{{ Route('gallery') }}">Gallery</a>
                                            <ul>
                                                <li><a href="{{ Route('gallery') }}">Gallery masonry</a></li>
                                                <li><a href="{{ Route('gallery_filter') }}">Gallery filter</a></li>
                                                <li><a href="{{ Route('gallery_grid') }}">Gallery Grid</a></li>
                                                <li><a href="{{ Route('gallery_carousel') }}">Gallery Carousel</a>
                                                </li>
                                            </ul>
                                        </li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        <li class="dropdown">
                                            <a href="#">Products</a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ Route('shop') }}">No sidebar</a></li>
                                                <li><a href="{{ Route('shop_left') }}">Left sidebar</a></li>
                                                <li><a href="{{ Route('shop_right') }}">Right sidebar</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="{{ Route('shop_carousel') }}">Products carousel</a></li>
                                        <li><a href="{{ Route('shop_details') }}">Product details</a></li>
                        ...
                        <a href="tel:(502)203-7840" class="main-header__phone">(502)
                            203-7840</a><!-- /.main-header__phone -->
		...
		"arrows": true,
		"dots": false,
		"prevArrow": "<button class=\"hero-slider__slick-button hero-slider__slick-button--prev\">Prev <i class=\"icon-left-arrow\"></i></button>",
		"nextArrow": "<button class=\"hero-slider__slick-button hero-slider__slick-button--next\"><i class=\"icon-right-arrow\"></i> Next</button>"
                    ...
                    <div class="main-slider__wrapper container-fluid">
                        <div class="main-slider__left">
                            <div class="main-slider__content">
                                ...
                                <!-- /.main-slider__text -->
                                <a href="{{ Route('about') }}" class="main-slider__btn floens-btn">
                        ...
                        <div class="main-slider__right">
                            <div class="main-slider__image">
                                <div class="main-slider__image__inner">
                                    <img src="assets/images/slider/slider-1-1.jpg" alt="slider"
                                        class="main-slider__image__one">
                                </div><!-- /.main-slider__image__inner -->
                                <img src="assets/images/shapes/slider-shape-1-1.jpg" alt="slider"
                                ...
                                <a href="https://www.youtube.com/watch?v=h9MbznbxlLc"
                                    ...
                                    style="background-image: url(assets/images/resources/slider-video-bg.png);">
                ...
                <div class="main-slider__item">
                    <div class="main-slider__wrapper container-fluid">
                        ...
                        <div class="main-slider__right">
                            <div class="main-slider__image">
                                <div class="main-slider__image__inner">
                                    <img src="assets/images/slider/slider-1-2.jpg" alt="slider"
                                        class="main-slider__image__one">
                                </div><!-- /.main-slider__image__inner -->
                                <img src="assets/images/shapes/slider-shape-1-1.jpg" alt="slider"
                                    class="main-slider__image__two">
                ...
                <div class="main-slider__item">
                    <div class="main-slider__wrapper container-fluid">
                        ...
                        <div class="main-slider__right">
                            <div class="main-slider__image">
                                <div class="main-slider__image__inner">
                                    <img src="assets/images/slider/slider-1-3.jpg" alt="slider"
                                        class="main-slider__image__one">
                                </div><!-- /.main-slider__image__inner -->
                                <img src="assets/images/shapes/slider-shape-1-1.jpg" alt="slider"
                                    class="main-slider__image__two">
                ...
                <div class="main-slider__item">
                    <div class="main-slider__wrapper container-fluid">
                        ...
                        <div class="main-slider__right">
                            <div class="main-slider__image">
                                <div class="main-slider__image__inner">
                                    <img src="assets/images/slider/slider-1-4.jpg" alt="slider"
                                        class="main-slider__image__one">
                                </div><!-- /.main-slider__image__inner -->
                                <img src="assets/images/shapes/slider-shape-1-1.jpg" alt="slider"
                                    class="main-slider__image__two">
                ...
                <div class="main-slider__item">
                    <div class="main-slider__wrapper container-fluid">
                        ...
                        <div class="main-slider__right">
                            <div class="main-slider__image">
                                <div class="main-slider__image__inner">
                                    <img src="assets/images/slider/slider-1-5.jpg" alt="slider"
                                        class="main-slider__image__one">
                                </div><!-- /.main-slider__image__inner -->
                                <img src="assets/images/shapes/slider-shape-1-1.jpg" alt="slider"
                                    class="main-slider__image__two">
		...
		"arrows": false
                ...
                <li>
                    <img src="assets/images/slider/slider-thumbs-1-1.jpg" alt="slider-thumbs">
                </li>
                <li>
                    <img src="assets/images/slider/slider-thumbs-1-2.jpg" alt="slider-thumbs">
                </li>
                <li>
                    <img src="assets/images/slider/slider-thumbs-1-3.jpg" alt="slider-thumbs">
                </li>
                <li>
                    <img src="assets/images/slider/slider-thumbs-1-4.jpg" alt="slider-thumbs">
                </li>
                <li>
                    <img src="assets/images/slider/slider-thumbs-1-5.jpg" alt="slider-thumbs">
                </li>
                <li>
                    <img src="assets/images/slider/slider-thumbs-1-6.jpg" alt="slider-thumbs">
                </li>
            </ul>
        ...
        <section class="services-one">
            <div class="services-one__bg" style="background-image: url(assets/images/backgrounds/services-bg-1.png);">
            </div>
            <!-- /.services-one__bg -->
            <div class="container">
                    ...
                    <div class="row gutter-y-50 align-items-center">
                        ...
                        <div class="col-lg-5">
                            <div class="services-one__top__button">
                                <a href="{{ Route('services') }}" class="floens-btn services-one__top__btn">
                                    <span>view all</span>
                                    <i class="icon-left-arrow"></i>
			...
			"responsive":{
                ...
                "1830":{
                        ...
                        <div class="service-card">
                            ...
                            <div class="service-card__top">
                                <div class="service-card__image">
                                    <img src="assets/images/services/service-1-1.jpg" alt="Tiling & concrete">
                    ...
                    <div class="item">
                        <div class="service-card">
                            ...
                            <div class="service-card__top">
                                <div class="service-card__image">
                                    <img src="assets/images/services/service-1-2.jpg" alt="Oak Flooring">
                                </div><!-- /.service-card__image -->
                                <div class="service-card__icon">
                            ...
                            <div class="service-card__content">
                                <h3 class="service-card__title"><a href='{{ Route('serviced_oak_flooring') }}'>Oak
                                        Flooring</a>
                    ...
                    <div class="item">
                        <div class="service-card">
                            ...
                            <div class="service-card__top">
                                <div class="service-card__image">
                                    <img src="assets/images/services/service-1-3.jpg" alt="Vinyl Plank">
                                </div><!-- /.service-card__image -->
                                <div class="service-card__icon">
                            ...
                            <div class="service-card__content">
                                <h3 class="service-card__title"><a href='{{ Route('serviced_vinyl_plank') }}'>Vinyl
                                        Plank</a>
                                </h3><!-- /.service-card__title -->
                                <p class="service-card__text">Laminate flooring is a type of synthetic flooring that
                                    designed like hardwood, tile, or other natural materials</p>
                    ...
                    <div class="item">
                        <div class="service-card">
                            ...
                            <div class="service-card__top">
                                <div class="service-card__image">
                                    <img src="assets/images/services/service-1-4.jpg" alt="Industrial Flooring">
                                </div><!-- /.service-card__image -->
                                <div class="service-card__icon">
                    ...
                    <div class="item">
                        <div class="service-card">
                            ...
                            <div class="service-card__top">
                                <div class="service-card__image">
                                    <img src="assets/images/services/service-1-5.jpg" alt="Carpets & Rugs">
                                </div><!-- /.service-card__image -->
                                <div class="service-card__icon">
                ...
                <div class="services-one__cursor d-none">
            ...
            <div class="container">
                <div class="services-one__info__inner">
                    <div class="services-one__info__bg"
                        style="background-image: url(assets/images/backgrounds/services-info-bg-1.png);"></div>
            ...
            <div class="container">
                ...
                <div class="offer-one__main-tab-box tabs-box">
                    <div class="offer-one__main-tab-box__bg"
                        style="background-image: url(assets/images/backgrounds/offer-bg-1.jpg);"></div>
                    <!-- /.offer-one__main-tab-box__bg -->
                    <div class="tab-box-buttons wow fadeInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <ul class="tab-buttons">
                            <li data-tab="#ModernTiels" class="tab-btn active-btn">
                                <button type="button" class="tab-btn__inner">Modern Tiels <span
                                        class="tab-btn__icon icon-left-arrow"></span></button>
                            </li>
                    ...
                    <div class="tabs-content wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="tab active-tab fadeInUp animated" data-wow-delay="200ms" id="ModernTiels"
                            ...
                            <div class="offer-one__service">
                                <div class="offer-one__service__image">
                                    <img src="assets/images/offer/offer-service-1-1.jpg" alt="offer-service">
                        ...
                        <div class="tab fadeInUp animated" data-wow-delay="200ms" id="FloorRemoval">
                            <div class="offer-one__service">
                                <div class="offer-one__service__image">
                                    <img src="assets/images/offer/offer-service-1-2.jpg" alt="offer-service">
                                    <div class="offer-one__service__shape offer-one__service__shape--one"></div>
                                    <!-- /.offer-one__service__shape -->
                                    <div class="offer-one__service__shape offer-one__service__shape--two"></div>
                                    <!-- /.offer-one__service__shape -->
                        ...
                        <div class="tab fadeInUp animated" data-wow-delay="200ms" id="KitchenStripOuts">
                            <div class="offer-one__service">
                                <div class="offer-one__service__image">
                                    <img src="assets/images/offer/offer-service-1-3.jpg" alt="offer-service">
                                    <div class="offer-one__service__shape offer-one__service__shape--one"></div>
                                    <!-- /.offer-one__service__shape -->
                                    <div class="offer-one__service__shape offer-one__service__shape--two"></div>
                                    <!-- /.offer-one__service__shape -->
                        ...
                        <div class="tab fadeInUp animated" data-wow-delay="200ms" id="WoodFloorRepair">
                            <div class="offer-one__service">
                                <div class="offer-one__service__image">
                                    <img src="assets/images/offer/offer-service-1-4.jpg" alt="offer-service">
                                    <div class="offer-one__service__shape offer-one__service__shape--one"></div>
                                    <!-- /.offer-one__service__shape -->
                                    <div class="offer-one__service__shape offer-one__service__shape--two"></div>
                                    <!-- /.offer-one__service__shape -->
        ...
        <section class="projects-one">
            <div class="projects-one__bg" style="background-image: url(assets/images/backgrounds/projects-bg-1.png);">
            </div>
            <!-- /.projects-one__bg -->
		...
		"responsive":{
			...
			"1800":{
				...
				"margin": 30
                    ...
                    <div class="item">
                        <div class="project-card @@extraClassName">
                            <a href="{{ Route('work_details') }}" class="project-card__image">
                                <img src="assets/images/works/project-1-1.jpg" alt="Modern Tiles">
                                    ...
                                    <div class="project-card__links__inner">
                                        ...
                                        <a href="{{ Route('work_details') }}"
                                            class="project-card__link floens-btn"><span
                                                class="icon-left-arrow"></span></a><!-- /.project-card__link -->
                    ...
                    <div class="item">
                        <div class="project-card @@extraClassName">
                            <a href="{{ Route('work_details') }}" class="project-card__image">
                                <img src="assets/images/works/project-1-2.jpg" alt="Modern Tiles">
                            </a><!-- /.project-card__image -->
                            <div class="project-card__content">
                                <h3 class="project-card__tagline">Tile Care</h3><!-- /.project-card__tagline -->
                                <div class="project-card__links">
                    ...
                    <div class="col-xl-6 col-lg-7 projects-one__content-col">
                        <div class="projects-one__content">
                            ...
                            <div class="projects-one__button">
                                <a href="{{ Route('work') }}"
                                    class="projects-one__btn floens-btn floens-btn--border">
                                    <span>view all</span>
                                    <i class="icon-left-arrow"></i>
            ...
            <img src="assets/images/shapes/projects-shape-1-1.jpg" alt="projects" class="projects-one__shape">
                ...
                <div class="row gutter-y-60">
                    <div class="col-lg-6">
                        <div class="reliable-one__content">
                            ...
                            <a href="{{ Route('contact') }}" class="floens-btn reliable-one__btn">
                                <span>get in touch</span>
                                <i class="icon-left-arrow"></i>
                    ...
                    <div class="col-lg-6 wow fadeInLeft" data-wow-duration="1500ms">
                        <div class="reliable-one__images">
                            <div class="reliable-one__image">
                                <img src="assets/images/reliable/reliable-1-1.jpg" alt="reliable"
                                    class="reliable-one__image__one">
                                <div class="reliable-one__image__inner">
                                    <img src="assets/images/reliable/reliable-1-2.jpg" alt="reliable"
        ...
        <section class="product-home">
            <div class="product-home__bg" style="background-image: url(assets/images/backgrounds/shop-bg-1.png);">
            </div>
            <!-- /.product-home__bg -->
            <div class="container">
                <div class="sec-title sec-title--center">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 ">
                        <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                            ...
                            <div class="product__item__content">
                                ...
                                <h4 class="product__item__title"><a href="{{ Route('shop_details') }}">Natural Stone
                                        Tiles</a>
                                </h4><!-- /.product-title -->
                                <div class="product__item__price">$82.00</div><!-- /.product-price -->
                                <a href="{{ Route('cart') }}" class="floens-btn product__item__link">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 ">
                        <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                            ...
                            <div class="product__item__content">
                                ...
                                <h4 class="product__item__title"><a href="{{ Route('shop_details') }}">Mosaic
                                        Tiles</a></h4>
                                <!-- /.product-title -->
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 ">
                        <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                            ...
                            <div class="product__item__content">
                                ...
                                <h4 class="product__item__title"><a href="{{ Route('shop_details') }}">Terracotta
                                        Tiles</a></h4>
                                <!-- /.product-title -->
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 ">
                        <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='300ms'>
                            ...
                            <div class="product__item__content">
                                ...
                                <h4 class="product__item__title"><a href="{{ Route('shop_details') }}">Encaustic
                                        Tiless</a></h4>
                                <!-- /.product-title -->
        ...
        <section class="testimonials-one section-space">
            <div class="container">
                <div class="row">
                    <div class="testimonials-one__image-col col-lg-6 wow fadeInRight" data-wow-duration="1500ms">
                        <div class="testimonials-one__image">
                            <img src="assets/images/testimonials/testimonials-image-1-1.jpg" alt="testimonials">
                            ...
                            <div class="item">
                                <div class="testimonials-card testimonials-card--two">
                                    ...
                                    <div class="testimonials-card__top">
                                        <svg class="testimonials-card__quotes__icon"
                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 87 64" fill="none">
                                            <path
                                                d="M0 40.1428H17.5714L5.85705 63.5713H23.4285L35.1428 40.1428V5H0V40.1428Z"
                                                fill="white" />
                                            <path
                                                d="M46.8572 5V40.1428H64.4286L52.7142 63.5713H70.2856L82 40.1428V5H46.8572Z"
                                                fill="white" />
                                            <path
                    ...
                    <div class="row gutter-y-50 align-items-center">
                        ...
                        <div class="col-lg-4">
                            <div class="blog-one__top__button">
                                <a href="{{ Route('blog_gridright') }}" class="floens-btn floens-btn--border">
                                    <span>view all</span>
                                    <i class="icon-left-arrow"></i>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-6 wow fadeInUp" data-wow-duration="1500ms"
                            ...
                            <div class="footer-widget footer-widget--about">
                                ...
                                <form action="#" data-url="MAILCHIMP_FORM_URL"
                                    ...
                                    <button type="submit" class="icon-left-arrow">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="1500ms"
                            ...
                            <div class="footer-widget footer-widget--links footer-widget--links-two">
                                ...
                                <ul class="list-unstyled footer-widget__links">
                                    <li><a href="{{ Route('services') }}">flooring service</a></li>
                                    <li><a href="{{ Route('services') }}">wooden Services</a></li>
                                    <li><a href="{{ Route('services') }}">corporate tiles</a></li>
                                    <li><a href="{{ Route('services') }}">carpet setup</a></li>
                                    <li><a href="{{ Route('services') }}">tiles setup</a></li>
                                </ul><!-- /.list-unstyled footer-widget__links -->
                            </div><!-- /.footer-widget -->
    ...
    <!-- toolbar js -->
    <script src="assets/vendors/floens-toolbar/js/js.cookie.min.js"></script>
    <script src="assets/vendors/floens-toolbar/js/jQuery.style.switcher.min.js"></script>
    <script src="assets/vendors/floens-toolbar/js/lang.js"></script>
    <script src="../../translate.google.com/translate_a/elementa0d8.js?cb=googleTranslateElementInit"></script>
    <script src="assets/vendors/floens-toolbar/js/floens-toolbar.js"></script>

</body>


<!-- Mirrored from bracketweb.com/floens-html/{{ Route('index_rtl') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:06:19 GMT -->
