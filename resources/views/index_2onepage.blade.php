...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('index_2onepage') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:14 GMT -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                    ...
                    <div class="main-header__left">
                        ...
                        <nav class="main-header__nav main-menu">
                            <ul class="main-menu__list one-page-scroll-menu">
                                ...
                                <li class="scrollToLink"><a href="#team">Our Team</a></li>
        ...
        <!-- services start -->
        <section class="services-two section-space-two" id="services">
            <div class="container">
        ...
        <!-- projects start -->
        <section class="projects-two projects-two--home section-space-bottom" id="projects">
        ...
        <!-- blog start -->
        <section class="blog-one blog-one--home-two section-space-two" id="blog">
            <div class="container">
