...
<head>
    ...
    <link href="{{asset('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500&amp;display=swap')}}"
        rel="stylesheet">
    <link href="{{asset('https://fonts.googleapis.com/css2?family=Quicksand:wght@700&amp;display=swap')}}" rel="stylesheet">
    <link href="{{asset('https://fonts.googleapis.com/css2?family=Manrope:wght@500&amp;display=swap')}}" rel="stylesheet">
