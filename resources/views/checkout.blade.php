...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('checkout') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:06:06 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Checkout || Floens || HTML Template For Tiling & Flooring</title>
    <!-- favicons Icons -->
                ...
                <div class="row gutter-y-30">
                    <div class="col-xl-8 col-lg-7">
                        <div class="checkout-page__billing-address">
                            ...
                            <form class="checkout-page__form row gutter-y-17">
                                <div class="col-xl-12">
                                ...
                                <div class="col-xl-12">
                                    <div class="checkout-page__input-box checkout-page__input-box--address">
                                        ...
                                        <input type="text" name="address" id="address" value=""
                                            placeholder="1837 E Homer M Adams Pkwy" required="">
                                ...
                                <div class="col-xl-12">
                                    <div class="checkout-page__input-box">
                                        ...
                                        <input type="text" name="town-city" id="town-city" value=""
                                            required="">
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="checkout-page__input-box">
                                        <label>State *</label>
                                        <select class="selectpicker" aria-label="Default select example">
                                            <option selected="">Georgia / ohio / new york</option>
                                            <option value="1">Dhaka</option>
                                            <option value="2">Berlin</option>
                                            <option value="3">Mumba</option>
                                ...
                                <div class="col-xl-12">
                                    <div class="checkout-page__input-box">
                                        ...
                                        <input name="zip-code" id="zip-code" type="text" pattern="[0-9]*"
                                            required>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                ...
                                <div class="col-xl-12">
                                    <div class="checkout-page__radio-box--left checkout-page__radio-box">
                                        <div class="checkout-page__input-item custom-radio">
                                            <input type="radio" id="account" name="checkout-info"
                                                class="custom-radio__input" checked>
                                            <label for="account" class="custom-radio__title">Create An
                                                Account?</label>
                                        </div>
                                        <div class="checkout-page__input-item custom-radio">
                                            <input type="radio" id="ship" name="checkout-info"
                                                class="custom-radio__input">
                                            <label for="ship" class="custom-radio__title">Ship To A Different
                                                Address?</label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="checkout-page__your-order">
                            ...
                            <table class="checkout-page__order-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="pro__title">Secretary desk</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pro__sub-price">$999.00</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <div class="checkout-page__order-address-data">
                                                <h4 class="checkout-page__order-address">Shipping Address</h4>
                                                <address class="checkout-page__order-address-text">2801 Lafayette Blvd,
                                                    Norfolk, Vermont 23509, united state</address>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <div class="checkout-page__radio-box checkout-page__radio-box--right">
                                                <div class="checkout-page__input-item custom-radio">
                                                    <input type="radio" id="direct" name="order-info"
                                                        class="custom-radio__input" checked>
                                                    <label for="direct" class="custom-radio__title">Direct Bank
                                                        Transfer</label>
                                                </div>
                                                <div class="checkout-page__input-item custom-radio">
                                                    <input type="radio" id="check" name="order-info"
                                                        class="custom-radio__input">
                                                    <label for="check" class="custom-radio__title">Check
                                                        Payments</label>
                                                </div>
                                                <div class="checkout-page__input-item custom-radio">
                                                    <input type="radio" id="cash" name="order-info"
                                                        class="custom-radio__input">
                                                    <label for="cash" class="custom-radio__title">Cash On
                                                        Delivery</label>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <p class="checkout-page__order-text">Your personal data will be used to
                                                process your order, support your experience throughout this website.</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <a href="{{ Route('checkout') }}"
                                                class="checkout-page__order-btn floens-btn">
                                                <span>checkout</span>
                                                <i class="icon-right-arrow"></i>
                                            </a>
                                        </td>
