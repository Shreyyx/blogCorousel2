...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('pricing_carousel') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:49 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Pricing Carousel || Floens || HTML Template For Tiling & Flooring</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <div class="container">
                ...
                <ul class="floens-breadcrumb list-unstyled">
                    ...
                    <li><span>Pricing carousel</span></li>
        ...
        <section class="pricing-page section-space">
            <div class="container">
                <div class="pricing-page__carousel floens-owl__carousel floens-owl__carousel--with-shadow floens-owl__carousel--basic-nav owl-carousel owl-theme"
                    data-owl-options='{
			"items": 1,
			"margin": 0,
			"loop": true,
				...
				"992": {
                        ...
                        <div class="pricing-card">
                            <div class="pricing-card__top">
                                <div class="pricing-card__top__content">
                                    <h3 class="pricing-card__title">Basic Plan</h3><!-- /.pricing-card__title -->
                                    <h4 class="pricing-card__price sec-title__title">$ 250 <span>month</span></h4>
                                    <!-- /.pricing-card__price -->
                                    <p class="pricing-card__text">as well as a board member of their software
                                        subsidiary. He is also an avoide</p>
                                    <!-- /.pricing-card__text -->
                                </div><!-- /.pricing-card__top__content -->
                                <div class="pricing-card__top__bg"
                                    style="background-image: url(assets/images/pricing/pricing-t-bg-1-2.jpg);">
                                </div><!-- /.pricing-card__top__bg -->
                            </div><!-- /.pricing-card__top -->
                            <div class="pricing-card__content">
                                <div class="pricing-card__content__bg"
                                    style="background-image: url(assets/images/pricing/pricing-l-bg-1-2.png);">
                    ...
                    <div class="item">
                        <div class="pricing-card">
                            <div class="pricing-card__top">
                                <div class="pricing-card__top__content">
                                    <h3 class="pricing-card__title">standard Plan</h3><!-- /.pricing-card__title -->
                                    <h4 class="pricing-card__price sec-title__title">$ 350 <span>month</span></h4>
                                    <!-- /.pricing-card__price -->
                                    <p class="pricing-card__text">as well as a board member of their software
                                        subsidiary. He is also an avoide</p>
                                    <!-- /.pricing-card__text -->
                                    <div class="pricing-card__discount">20% off</div><!-- /.pricing-card__discount -->
                                </div><!-- /.pricing-card__top__content -->
                                <div class="pricing-card__top__bg"
                                    style="background-image: url(assets/images/pricing/pricing-t-bg-1-2.jpg);">
                                </div><!-- /.pricing-card__top__bg -->
                    ...
                    <div class="item">
                        <div class="pricing-card">
                            <div class="pricing-card__top">
                                <div class="pricing-card__top__content">
                                    <h3 class="pricing-card__title">premium Plan</h3><!-- /.pricing-card__title -->
                                    <h4 class="pricing-card__price sec-title__title">$ 650 <span>month</span></h4>
                                    <!-- /.pricing-card__price -->
                                    <p class="pricing-card__text">as well as a board member of their software
                                        subsidiary. He is also an avoide</p>
                                    <!-- /.pricing-card__text -->
