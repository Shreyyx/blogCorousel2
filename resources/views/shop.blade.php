...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('shop') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:59 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Shop || Floens || HTML Template For Tiling & Flooring</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Shop grid</h2>
                        ...
                        <div class="row gutter-y-30">
                                ...
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms'
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a
                                                href="{{ Route('shop_details') }}">Natural Stone
                                                Tiles</a></h4><!-- /.product-title -->
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 ">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms'
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a
                                                href="{{ Route('shop_details') }}">Terracotta
                                                Tiles</a></h4><!-- /.product-title -->
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 ">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms'
                                    ...
                                    <div class="product__item__image">
                                        <img src="assets/images/products/product-1-4.jpg" alt="Fish Scale Tiles">
                                    </div><!-- /.product-image -->
                                    <div class="product__item__content">
                                        <div class="floens-ratings product__item__ratings">
                                            <span class="icon-star"></span>
                                        ...
                                        <h4 class="product__item__title"><a href="{{ Route('shop_details') }}">Fish
                                                Scale
                                                Tiles</a></h4><!-- /.product-title -->
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 ">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms'
                                    ...
                                    <div class="product__item__image">
                                        <img src="assets/images/products/product-1-5.jpg" alt="Digital Print Tiles">
                                    </div><!-- /.product-image -->
                                    <div class="product__item__content">
                                        <div class="floens-ratings product__item__ratings">
                                            <span class="icon-star"></span>
                                        ...
                                        <h4 class="product__item__title"><a
                                                href="{{ Route('shop_details') }}">Digital Print
                                                Tiles</a></h4><!-- /.product-title -->
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 ">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms'
                                    ...
                                    <div class="product__item__image">
                                        <img src="assets/images/products/product-1-6.jpg" alt="Penny Tiles">
                                    </div><!-- /.product-image -->
                                    <div class="product__item__content">
                                        <div class="floens-ratings product__item__ratings">
                                            <span class="icon-star"></span>
                                        ...
                                        <h4 class="product__item__title"><a href="{{ Route('shop_details') }}">Penny
                                                Tiles</a>
                                        </h4><!-- /.product-title -->
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 ">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms'
                                    ...
                                    <div class="product__item__image">
                                        <img src="assets/images/products/product-1-7.jpg" alt="Tiling & concrete">
                                    </div><!-- /.product-image -->
                                    <div class="product__item__content">
                                        <div class="floens-ratings product__item__ratings">
                                            <span class="icon-star"></span>
                                        ...
                                        <h4 class="product__item__title"><a href="{{ Route('shop_details') }}">Tiling
                                                &
                                                concrete</a></h4><!-- /.product-title -->
                                        <div class="product__item__price">$40.00</div><!-- /.product-price -->
                                        <a href="{{ Route('cart') }}" class="floens-btn product__item__link">
                                            <span>Add to Cart</span>
                                            <i class="icon-cart"></i>
                                        </a>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 ">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms'
                                    ...
                                    <div class="product__item__image">
                                        <img src="assets/images/products/product-1-8.jpg" alt="Vein Patterns">
                                    </div><!-- /.product-image -->
                                    <div class="product__item__content">
                                        <div class="floens-ratings product__item__ratings">
                                            <span class="icon-star"></span>
                                        ...
                                        <h4 class="product__item__title"><a href="{{ Route('shop_details') }}">Vein
                                                Patterns</a>
                                        </h4><!-- /.product-title -->
                                        <div class="product__item__price">$90.00</div><!-- /.product-price -->
                                        <a href="{{ Route('cart') }}" class="floens-btn product__item__link">
                                            <span>Add to Cart</span>
                                            <i class="icon-cart"></i>
                                        </a>
...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('shop') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:06:03 GMT -->
