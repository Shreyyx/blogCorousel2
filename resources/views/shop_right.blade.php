...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('shop_right') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:06:03 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Shop Right Sidebar || Floens || HTML Template For Tiling & Flooring</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Shop right sidebar</h2>
                        ...
                        <aside class="product__sidebar">
                            ...
                            <div class="product__categories product__sidebar__item">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="{{ Route('shop_right') }}" data-text="Metal Tiles"><span>Metal
                                                Tiles</span></a>
                                    </li>
                                    <li><a href="{{ Route('shop_right') }}"
                                            data-text="Hexagonal Tiles"><span>Hexagonal
                                                Tiles</span></a></li>
                                    <li><a href="{{ Route('shop_right') }}" data-text="Penny Tiles"><span>Penny
                                                Tiles</span></a>
                                    </li>
                                    <li><a href="{{ Route('shop_right') }}"
                                            data-text="Patterned Tiles"><span>Patterned
                                                Tiles</span></a></li>
                                    <li><a href="{{ Route('shop_right') }}" data-text="Fish Scale Tilesr"><span>Fish
                                                Scale
                                                Tiles</span></a></li>
                                </ul>
                            </div><!-- /.category-widget -->
