...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('gallery_filter') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:51 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Gallery Filter || Floens || HTML Template For Tiling & Flooring</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Gallery Filter</h2>
            ...
            <div class="container-fluid">
                <div class="text-center">
                    <ul class="list-unstyled post-filter gallery-one__filter__list">
                        ...
                        <li data-filter=".concrete"><span>concrete</span></li>
                        <li data-filter=".flooring"><span>flooring</span></li>
                        <li data-filter=".vinyl-plank"><span>vinyl plank</span></li>
                        <li data-filter=".carpets"><span>carpets</span></li>
                        <li data-filter=".vein-patterns"><span>vein patterns</span></li>
                    </ul><!-- /.list-unstyledf -->
                </div><!-- /.text-center -->
                <div class="row masonry-layout filter-layout">
                    <div class="col-sm-6 col-xl-3 filter-item flooring">
                    ...
                    <div class="col-sm-6 col-xl-6 filter-item concrete">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-2.jpg" alt="gallery">
                            <div class="gallery-one__card__hover">
                    ...
                    </div><!-- /.col-sm-6 col-xl-6 -->
                    <div class="col-sm-6 col-xl-3 filter-item vinyl-plank carpets">
                        <div class="gallery-one__card">
                    ...
                    <div class="col-sm-6 col-xl-3 filter-item thermo-stone">
                        <div class="gallery-one__card">
                    ...
                    <div class="col-sm-6 col-xl-3 filter-item thermo-stone concrete vein-patterns">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-6.jpg" alt="gallery">
                            <div class="gallery-one__card__hover">
                    ...
                    <div class="col-sm-6 col-xl-3 filter-item flooring carpets">
                        <div class="gallery-one__card">
