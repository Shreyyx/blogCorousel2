...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('team_details') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:43 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Our Team Details || Floens || HTML Template For Tiling & Flooring</title>
    <!-- favicons Icons -->
            ...
            <div class="container">
                <div class="team-details__inner wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                    <div class="team-details__image">
                        <img src="assets/images/team/team-d-1.jpg" alt="Kenneth Z. Burke">
                    </div><!-- /.team-details__image -->
                    <div class="team-details__content">
                        <div class="team-details__top">
                            <div class="team-details__identity">
                                <h4 class="team-details__name">Kenneth Z. Burke</h4><!-- /.team-details__name -->
                                <span class="team-details__designation">Gemini market</span>
                        ...
                        <div class="team-details__description">
                            <p class="team-details__text">Prior to joining company, she spent 20+ years at Inmosys,
                                where he
                                held a wide range of global leadership roles, from services to products, and across
                                operations and sales. Most recently, he was SVP & Global Head of the Manufacturing
                                business..</p><!-- /.team-details__text -->
                            <p class="team-details__text">as well as a board member of their software subsidiary. He is
                                also
                                an avid cook and history buff. You can find him dining late at night with the chefs of
                                the
                                hotels where he stays during his travels</p><!-- /.team-details__text -->
                        </div><!-- /.team-details__description -->
                        <img src="assets/images/team/team-d-sign-1.png" alt="team-d-sign">
                        <ul class="team-details__info">
                            ...
                            <li>
                                ...
                                <a href="https://www.google.com/maps/@23.506657,90.3443647,7z?entry=ttu">26 Manor St,
                                    Braintree UK</a>
                            </li>
            ...
            <div class="container">
                <div class="team-skills-one__info">
                    <div class="team-skills-one__content">
                        <h3 class="team-skills-one__title">Personal Information</h3><!-- /.team-skills-one__title -->
                        <div class="team-skills-one__description wow fadeInUp" data-wow-duration="1500ms"
                            data-wow-delay="00ms">
                            <p class="team-skills-one__text">There are many variations of passages of Lorem Ipsum
                                ...
                                predefined chunks as necessary,</p><!-- /.team-skills-one__text -->
                            <p class="team-skills-one__text">There are many variations of passages of Lorem Ipsum
                                available, but the majority have suffered alteration in some form, by injected humour,
                                or randomised words which don't look even slightly believable. If you are going to use a
                                passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in
                ...
                <div class="team-skills-one__skills">
                    <h3 class="team-skills-one__title team-skills-one__skills__title">Personal skills</h3>
                    <!-- /.team-skills-one__title -->
                    <div class="team-skills-one__skills__inner">
                        <div class="team-skills-one__progress">
                            <h4 class="team-skills-one__progress__title">Quality of Meat</h4>
                            <div class="team-skills-one__progress__bar">
                                <div class="team-skills-one__progress__inner count-bar" data-percent="95%">
                                    <div class="team-skills-one__progress__number count-text">95%</div>
                                </div>
                            </div>
                        </div><!-- /.skills-item -->
                        <div class="team-skills-one__progress">
                    ...
                    </div><!-- /.team-skills-one__skills__inner -->
                    <div class="team-skills-one__description wow fadeInUp" data-wow-duration="1500ms"
                        data-wow-delay="00ms">
                        <p class="team-skills-one__text">There are many variations of passages of Lorem Ipsum
                            ...
                            chunks as necessary,</p><!-- /.team-skills-one__text -->
                    </div><!-- /.team-skills-one__description -->
                </div><!-- /.team-skills-one__skills -->
            </div><!-- /.container -->
...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('team_details') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:44 GMT -->
