...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                ...
                <div class="main-header__inner">
                    ...
                    <div class="main-header__right">
                        ...
                        <a href="{{ Route('contact') }}" class="floens-btn main-header__btn">
                            <span style="white-space: nowrap">Company Brochure</span>
                            <i style="font-size: 15px;"class="icon-right-arrow"></i>

                        </a>
                        <a href="{{ Route('contact') }}" class="floens-btn main-header__btn">
                            <span style="white-space: nowrap">get a quote</span>
                            <i style="font-size: 15px;"class="icon-right-arrow"></i>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 wow fadeInLeft" data-wow-duration="1500ms">
                        <div class="about-three__image">
                            <div class="about-three__image__inner">
                                ...
                                <img src="assets/images/londa-1.png" alt="about" class="about-three__image__two">
                ...
                "1600":{
                        ...
                        <div class="service-card-two">
                            ...
                            <div class="service-card-two__content">
                                <h3 class="service-card-two__title"><a
                                        href='{{ Route('serviced_industrial_flooring') }}'>Indian Marble</a></h3>
                    ...
                    <div class="item">
                        <div class="service-card-two">
                            ...
                            <div class="service-card-two__content">
                                <h3 class="service-card-two__title"><a
                                        href='{{ Route('serviced_carpets_rugs') }}'>Italian Marble</a></h3>
                                <!-- /.service-card-two__title -->
                                <div class="service-card-two__bottom">
                    ...
                    <div class="item">
                        <div class="service-card-two">
                            ...
                            <div class="service-card-two__content">
                                <h3 class="service-card-two__title"><a
                                        href='{{ Route('serviced_oak_flooring') }}'>Elevation</a></h3>
                                <!-- /.service-card-two__title -->
                                <div class="service-card-two__bottom">
                    ...
                    <div class="item">
                        <div class="service-card-two">
                            ...
                            <div class="service-card-two__content">
                                <h3 class="service-card-two__title"><a
                                        href='{{ Route('serviced_vinyl_plank') }}'>Sand Stone</a></h3>
                                <!-- /.service-card-two__title -->
                                <div class="service-card-two__bottom">
        ...
        <section class="reliable-one reliable-one--home-three section-space-bottom">
            <div class="container">
                <div class="row gutter-y-60">
                    <div class="col-lg-6">
                        <img src="assets/images/Achievement-graph1.png" height="auto" width="100%" alt="reliable"
                                ...
                                <div class="contact-one__info__content">
                                    ...
                                    <div class="contact-one__info__item side-by-side">
                                        <div class="contact-one__info__item__inner">
                                            ...
                                            <p class="contact-one__info__text"><a href="tel:7425824566">7425824566</a>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="contact-one__info__item">
                                        <div class="contact-one__info__item__inner">
                                            ...
                                            <address class="contact-one__info__text">Riico
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="{{ Route('index_4') }}" aria-label="logo image"><img
                        src="{{ asset('assets/images/Projects/Screenshot_2024-05-15_181714-removebg-preview.png') }}"
