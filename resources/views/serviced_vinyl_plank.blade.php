    ...
    <body class="custom-cursor">
        ...
        <div class="page-wrapper">
            <section class="page-header">
                ...
                <!-- /.page-header__bg -->
                <div class="container">
                    <h2 class="page-header__title">Sand Stone</h2>
                    <ul class="floens-breadcrumb list-unstyled">
                        <li><i class="icon-home"></i> <a href="{{ Route('index_2') }}">Home</a></li>
                        <li><span>services</span></li>
                        <li><span>Sand Stone</span></li>
                    </ul>
                </div>
            </section>
                        ...
                        <div class="col-md-12 col-lg-8">
                            <div class="service-details__content">
                                <div class="service-details__inner">
                                    ...
                                    <h3 class="service-details__title">SAND STONE</h3>
                                    <hr>
                                </div>
                                <div class="service-details__inner-two">
                                    <h3 class="service-details__sub-title">
                                        TRANSFORMING NATURE'S BEAUTY INTO TIMELESS ELEGANCE WITH OUR EQUISITE SANDSTONE</h3>
                                </div>
                            </div>
                        </div>
                    </div>
