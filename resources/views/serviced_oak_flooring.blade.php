    ...
    <body class="custom-cursor">
        ...
        <div class="page-wrapper">
            <section class="page-header">
                ...
                <!-- /.page-header__bg -->
                <div class="container">
                    <h2 class="page-header__title">Elevation</h2>
                        ...
                        <div class="col-md-12 col-lg-8">
                            <div class="service-details__content">
                                <div class="service-details__inner">
                                    ...
                                    <h3 class="service-details__title">ELEVATION</h3>
                                    <hr>
                                </div>
                                <div class="service-details__inner-two">
                                    <h3 class="service-details__sub-title">
                                        "TRANSFORMING SPACES WITH THE TIMELESS ELEGANCE OF MARBLE AND GRANITE, ELEVATING EVERY ENVIRONMENT WITH NATURAL BEAUTY AND DISTINCTION."</h3>
                                </div>
                            </div>
                        </div>
                    </div>
