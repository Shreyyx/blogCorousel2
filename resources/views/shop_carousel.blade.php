...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('shop_carousel') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:06:03 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Shop Carousel || Floens || HTML Template For Tiling & Flooring</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Shop carousel</h2>
        ...
        <section class="product-page product-page--carousel section-space-bottom">
            <div class="container">
                    ...
                    <div class="item">
                        <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='300ms'>
                            ...
                            <div class="product__item__content">
                                ...
                                <h4 class="product__item__title"><a href="{{ Route('shop_details') }}">Fish Scale
                                        Tiles</a></h4>
                                <!-- /.product-title -->
                    ...
                    <div class="item">
                        <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='400ms'>
                            ...
                            <div class="product__item__content">
                                ...
                                <h4 class="product__item__title"><a href="{{ Route('shop_details') }}">Digital Print
                                        Tiles</a>
                                </h4><!-- /.product-title -->
