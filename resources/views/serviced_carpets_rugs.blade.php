...
@section('content')
    ...
    <body class="custom-cursor">
        ...
        <section class="page-header">
            <div class="page-header__bg" style="background-image: url('assets/images/backgrounds/page-header-bg-1-1.png');">
            </div>
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Carpets & Rugs</h2>
                <ul class="floens-breadcrumb list-unstyled">
                    <li><i class="icon-home"></i> <a href="{{ Route('index_2') }}">Home</a></li>
                    <li><span>services</span></li>
                    <li><span>Carpets & Rugs</span></li>
                        ...
                        <div class="service-details__content">
                            <div class="service-details__inner">
                                <div class="service-details__thumbnail wow fadeInUp" data-wow-duration="1500ms"
                                    data-wow-delay="00ms">
                                    <img src="assets/images/services/service-d-1.jpg" alt="Carpets & Rugs">
                                </div><!-- /.service-details__thumbnail -->
                                <h3 class="service-details__title">Carpets & Rugs</h3><!-- /.service-details__title -->
