...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('gallery_carousel') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:53 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Gallery Carousel || Floens || HTML Template For Tiling & Flooring</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="gallery-one section-space">
            <div class="container-fluid">
                <div class="gallery-one__carousel floens-owl__carousel  floens-owl__carousel--basic-nav owl-carousel owl-theme"
                    data-owl-options='{
			"items": 1,
			"margin": 0,
			"loop": true,
			...
			"responsive": {
				...
				"1600": {
                    ...
                    <div class="item">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-11.jpg" alt="">
                            <div class="gallery-one__card__hover">
