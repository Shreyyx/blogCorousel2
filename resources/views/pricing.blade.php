...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('pricing') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:48 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Pricing || Floens || HTML Template For Tiling & Flooring</title>
    <!-- favicons Icons -->
            ...
            <div class="container">
                ...
                <div class="pricing-page__main-tab-box tabs-box">
                    ...
                    <div class="tabs-content">
                            ...
                            <div class="row gutter-y-30">
                                    ...
                                    <div class="pricing-card">
                                        <div class="pricing-card__top">
                                            <div class="pricing-card__top__content">
                                                ...
                                                <!-- /.pricing-card__title -->
                                                <h4 class="pricing-card__price sec-title__title">$ 250
                                                    <span>month</span>
                                                </h4>
                                                <!-- /.pricing-card__price -->
                                                <p class="pricing-card__text">as well as a board member of their
                                                    software
                                        ...
                                        <div class="pricing-card__content">
                                            ...
                                            <div class="pricing-card__button">
                                                <a href="{{ Route('contact') }}"
                                                    class="floens-btn pricing-card__btn">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="pricing-card">
                                        <div class="pricing-card__top">
                                            <div class="pricing-card__top__content">
                                                <h3 class="pricing-card__title">standard Plan</h3>
                                                <!-- /.pricing-card__title -->
                                                <h4 class="pricing-card__price sec-title__title">$ 350
                                                    <span>month</span>
                                                </h4>
                                                <!-- /.pricing-card__price -->
                                                <p class="pricing-card__text">as well as a board member of their
                                                    ...
                                                    subsidiary. He is also an avoide</p>
                                                <!-- /.pricing-card__text -->
                                                <div class="pricing-card__discount">20% off</div>
                                    ...
                                    <div class="pricing-card">
                                        <div class="pricing-card__top">
                                            <div class="pricing-card__top__content">
                                                ...
                                                <!-- /.pricing-card__title -->
                                                <h4 class="pricing-card__price sec-title__title">$ 650
                                                    <span>month</span>
                                                </h4>
                                                <!-- /.pricing-card__price -->
                                                <p class="pricing-card__text">as well as a board member of their
                        ...
                        <div class="tab fadeInUp animated" data-wow-delay="200ms" id="Monthly"
                            style="display: none;">
                            <div class="row gutter-y-30">
                                <div class="col-lg-4 col-md-6">
                                    <div class="pricing-card">
...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('pricing') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:49 GMT -->
