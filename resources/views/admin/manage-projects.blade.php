...
@section('content')
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h2 class="modal-title" id="sign_up_popupLabel2">Add project</h2>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="twm-tabs-style-2">
                            <form id="f" action="{{ 'save-projects' }}" method="POST"
                                ...
                                <div class="tab-content" id="myTab2Content">
                                    ...
                                    <div class="tab-pane fade show active" id="login-candidate">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    <label for="service"><b>service<span class="text-danger">
                                                                *</span></b></label>
                                                    <input name="service" type="text" id="service" class="form-control"
    ...
    @foreach ($data as $projects)
        <div style="width:100%;" class="modal fade twm-sign-up" id="editModal{{ $projects->id }}" tabindex="-1"
            role="dialog" aria-labelledby="exampleModalLabel{{ $projects->id }}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel{{ $projects->id }}">Edit project</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <!-- Form for editing blog -->
                        <form id="editForm{{ $projects->id }}"
                            action="{{ route('update-projects', ['id' => $projects->id]) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="tab-content" id="myTab2Content">
                                <!--Login Candidate Content-->
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                <label for="service"><b>service<span class="text-danger">
                                                            *</span></b></label>
                                                <input name="service" type="text" id="service" class="form-control"
                                                    value="{{ $projects->service }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12" style="text-align: center;">
                                            <button id="submit" type="submit" class="btn btn-outline-dark"><i
