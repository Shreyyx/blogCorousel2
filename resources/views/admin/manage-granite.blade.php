...
@section('content')
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="twm-tabs-style-2">
                            <form id="f" action="{{ 'save-granite' }}" method="POST"
    ...
    @foreach ($data as $granites)
        <div style="width:100%;" class="modal fade twm-sign-up" id="editModal{{ $granites->id }}" tabindex="-1"
            role="dialog" aria-labelledby="exampleModalLabel{{ $granites->id }}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel{{ $granites->id }}">Edit marble</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <!-- Form for editing blog -->
                        <form id="editForm{{ $granites->id }}"
                            action="{{ route('update-granite', ['id' => $granites->id]) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="tab-content" id="myTab2Content">
                                <!--Login Candidate Content-->
