...
<!-- Mirrored from bracketweb.com/floens-html/{{ Route('work_carousel') }} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 07:05:46 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Work || Floens || HTML Template For Tiling & Flooring</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="work-page work-page--carousel section-space-bottom">
            <div class="container">
                <div class="work-page__carousel floens-owl__carousel floens-owl__carousel--basic-nav owl-carousel owl-theme"
                    data-owl-options='{
                "items": 1,
                "margin": 0,
                "loop": true,
